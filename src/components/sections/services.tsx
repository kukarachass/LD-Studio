 ...
 *
 * Розкриття зроблено через <Disclosure> (CSS grid-template-rows), а не
                    ...
                    {SERVICES.map((service, i) => {
                        ...
                        return (
                            <Reveal
                                ...
                                className="border-b border-line [contain:layout_paint]"
                            >
                                <div
                                    id={service.slug}
                      ...
                      специфікація HTML. */}
                                    <h3>
                                        <button
                                            ...
                                            /* Лише на десктопі: на тачі focus спрацьовує перед click,
                                               рядок встигає стати активним — і click одразу його закриває. */
                                            onFocus={() => isDesktop && setActiveSlug(service.slug)}
